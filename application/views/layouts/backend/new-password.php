...
<head>
	...
	<title>AMB | Change New Password</title>
...
<div class="login-box">
	...
	<div class="login-box-body">
		<p class="login-box-msg">
			<?= empty($this->session->flashdata('message')) ? 'Masukkan kata sandi baru Anda.': '<span class="text-danger">'.$this->session->flashdata('message').'</span>'; ?>
		</p>
		<span></span>
		<form action="<?php echo site_url('backend/change-password'); ?>" method="post">
