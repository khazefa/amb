...
final class BDCI_SimpleLibraryLoader {
    ...
    {
        $outer_lib = realpath(FCPATH . '../../lib/simple-botdetect.php');
        $inner_root_dir_lib = FCPATH . 'lib' . DIRECTORY_SEPARATOR . 'simple-botdetect.php';
        $inner_app_dir_lib = BDCI_LIB_PATH . 'lib' . DIRECTORY_SEPARATOR . 'simple-botdetect.php';
    ...
    private static function show_error_library_include_message()
    {
        ...
        echo 'You have downloaded our CodeIgniter example, but you are missing BotDetect Captcha library which comes as a separate download. To resolve the issue:
            ...
            <br><br>1) Download BotDetect PHP CAPTCHA Library from here: <a href="http://captcha.com/captcha-download.html?version=php&amp;utm_source=installation&amp;utm_medium=php&amp;utm_campaign=CodeIgniter">https://captcha.com/captcha-download.html?version=php</a>
            ...
            <br><br>Here is where you can find more details: <a href="http://captcha.com/doc/php/howto/codeigniter-captcha.html?utm_source=installation&amp;utm_medium=php&amp;utm_campaign=CodeIgniter">https://captcha.com/doc/php/howto/codeigniter-captcha.html</a>
            <br>';
        die;
    }
