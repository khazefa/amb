...
{
    protected $tbl_media = 'mediaartikel';
    protected $primKey = 'mediaID';
    protected $indexKey = 'mediacode';
    protected $order = array('mediatitle' => 'asc'); // default order
    ...
    {
        $this->db->trans_start();
        $this->db->insert($this->tbl_media, $dataInfo);
    ...
    function update_data($dataInfo, $id)
    {
        ...
        $this->db->update($this->tbl_media, $dataInfo);
