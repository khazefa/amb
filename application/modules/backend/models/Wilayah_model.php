...
{
    protected $tbl_wilayah = 'wilayahartikel';
    protected $primKey = 'wilayahID';
    protected $indexKey = 'wilayahcode';
    protected $order = array('wilayahtitle' => 'asc'); // default order
    ...
    {
        $this->db->trans_start();
        $this->db->insert($this->tbl_wilayah, $dataInfo);
    ...
    function update_data($dataInfo, $id)
    {
        ...
        $this->db->update($this->tbl_wilayah, $dataInfo);
    ...
    {
        $this->db->where($this->indexKey, $id);
        $this->db->delete($this->tbl_wilayah);
