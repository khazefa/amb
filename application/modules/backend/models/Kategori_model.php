...
{
    protected $tbl_kategori = 'kategoriartikel';
    protected $primKey = 'kategoriID';
    protected $indexKey = 'kategoricode';
    protected $order = array('kategorititle' => 'asc'); // default order
