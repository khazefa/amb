<?php
/**
 * Class ModuleRights_model.php.
 * Desc: Module Rights Model
 * @author: Sigit Prayitno
 * @email: cybergitt@gmail.com
 */

class ModuleRights_model extends CI_Model
{
    protected $tbl_module = 'module_rights';
    protected $primKey = 'modr_id';
    protected $indexKey = 'adminID';
    protected $order = array('modr_id' => 'asc'); // default order
    ...
    {
        $this->db->trans_start();
        $this->db->insert($this->tbl_module, $dataInfo);
    ...
    {
        $this->db->where($this->primKey, $id);
        $this->db->update($this->tbl_module, $dataInfo);
    ...
    {
        $this->db->where($this->primKey, $id);
        $this->db->delete($this->tbl_module);
    ...
    /**
     * This function is used to delete the data information
     * @param number $uid : This is data uid
     * @return boolean $result : TRUE / FALSE
     */
    function delete_data_by_uid($uid)
    {
        $this->db->where($this->indexKey, $uid);
        $this->db->delete($this->tbl_module);
