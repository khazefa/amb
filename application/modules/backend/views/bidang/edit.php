            ...
            <div class="box box-default">
                ...
                <input type="hidden" name="fid" id="fid" value="<?php echo $records[0]['id'];?>">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Sub Judul <span class="text-danger">*</span></label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="fsubname" name="fsubname" value="<?php echo $records[0]['subname'];?>" required="required">
                            </div>
                        </div>
                        <div class="form-group">
