            ...
            <div class="box box-default">
                ...
                <input type="hidden" name="fcode" id="fcode" value="<?php echo $records[0]['code'];?>">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Tipe Media</label>
                            <div class="col-sm-4">
                                <select id="ftype" name="ftype" class="form-control">
                                    <option value="Media Cetak" <?php echo $records[0]['type'] === 'Media Cetak' ? 'selected' : '' ;?>>Media Cetak</option>
                                    <option value="Media TV" <?php echo $records[0]['type'] === 'Media TV' ? 'selected' : '' ;?>>Media TV</option>
                                    <option value="Media Online" <?php echo $records[0]['type'] === 'Media Online' ? 'selected' : '' ;?>>Media Online</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
