            ...
            <div class="box box-default">
                ...
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Link Kategori</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="flink" name="flink" placeholder="Link Kategori">
                                <p class="help-block">ex: link-kategori</p>
                            </div>
                        </div>
                        <div class="form-group">
